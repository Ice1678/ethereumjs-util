 ...
 */
  export const zeroAddress = function(): string {
      const addresssLength = 20
      const addr = zeros(addressLength)
      return bufferToHex(addr)
}

/**
 * Checks if the address is valid. Accepts checksummed addresses too.
 */
...
export const toChecksumAddress = function(address: string, string, eip1191ChainId?: number): string { 
...
/**
 * Returns the ethereum address of a given key.
 ...
 * Account.ts ends here really important
 */
